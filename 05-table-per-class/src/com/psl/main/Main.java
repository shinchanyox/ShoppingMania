...
//		Contact c2 = new Contact("shinchan","nohara","email2",Date.valueOf("1994-03-28"),new Address("hima","mari")) ;
		...
		Contact c2 = new Friend("andre","bista","email1",Date.valueOf("2001-01-01"),new Address("yo","man"),"pikachu") ;
		Contact c3 = new Relative("andre","bista","email1",Date.valueOf("2001-01-01"),new Address("yo","man"),"bulbasaur") ;
